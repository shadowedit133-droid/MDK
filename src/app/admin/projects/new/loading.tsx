...
export default function AdminProjectFormLoading() {
  return (
    <div className="space-y-6 max-w-4xl mx-auto animate-pulse" aria-busy="true" aria-label="Loading project form">
      {/* Header Skeleton */}
      <div className="space-y-2">
        <div className="h-8 w-64 sm:w-80 bg-zinc-800/80 rounded-xl" />
